...
- 用户询问“推荐下一步开发”时，结合当前代码状态和 OMP/Tau 经验，指出项目短板并给出下一步计划,可自主去阅读 tau/omp 项目。
- tau项目在 /home/harukiz/workspace/agent/tau, omp项目在 /home/harukiz/workspace/agent/oh-my-pi
